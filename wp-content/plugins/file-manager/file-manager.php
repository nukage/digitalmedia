		...
		$opts = array(
			...
			'roots' => array(
				array(
					...
					// 'mimeDetect'   => 'internal',
					// 'mimefile' => '/var/www/html/file-manager/wp-content/plugins/file-manager/elFinder/php/mime.types',
					// 'mimefile' => plugin_dir_path(__FILE__) . 'elFinder' . DIRECTORY_SEPARATOR . 'php' . DIRECTORY_SEPARATOR . 'mime.types',
				)
			)
		);
