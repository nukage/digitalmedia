...
class Toolset_User_Editors_Editor_Screen_Gutenberg_Backend
	...
	public function initialize() {
		...
		add_action( 'block_editor_meta_box_hidden_fields', array( $this, 'register_assets_for_gutenberg_compatibility' ) );
	...
	public function register_inline_editor_action_buttons( $content_template ) {
		$content_template_has_gutenberg = ( get_post_meta( $content_template->ID, '_toolset_user_editors_editor_choice', true ) === Toolset_User_Editors_Editor_Gutenberg::GUTENBERG_SCREEN_ID );
		?>
		<button
