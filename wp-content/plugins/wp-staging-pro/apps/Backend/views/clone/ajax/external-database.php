...
if( empty( $options->current ) || null === $options->current ) {
    ...
    <p><label><input type="checkbox" id="wpstg-ext-db" name="wpstg-ext-db" value="true">
            ...
            <br><?php _e( 'Database must be created manually in advance!<br/><br/><strong>Important:</strong> If there are tables with the same database prefix and name in the database they will be dropped without any further asking!', 'wp-staging' ); ?>
        </label></p>
