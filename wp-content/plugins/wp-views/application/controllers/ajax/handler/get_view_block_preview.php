...
class WPV_Ajax_Handler_Get_View_Block_Preview extends Toolset_Ajax_Handler_Abstract {
	...
	public function __construct(
		...
		\WP_Views $wp_views = null
	) {
		parent::__construct( $ajax_manager );

		$this->constants = $constants ?: new \Toolset_Constants();

		$this->toolset_renderer = $toolset_renderer ?: \Toolset_Renderer::get_instance();

		$this->template_repository = $template_repository ?: \Toolset_Output_Template_Repository::get_instance();

		global $WP_Views;
		$this->wp_views = $wp_views ?: $WP_Views;
	}
