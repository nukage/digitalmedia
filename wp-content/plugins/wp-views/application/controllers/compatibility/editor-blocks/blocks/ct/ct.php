...
class Block extends ViewsEditorBlocks\Base {
	...
	public function register_block_editor_assets() {
		$this->toolset_assets_manager->register_script(
			'toolset-ct-block-js',
			$this->constants->constant( 'WPV_URL' ) . ViewsEditorBlocks\Blocks::VIEWS_BLOCKS_ASSETS_RELATIVE_PATH . '/js/ct.block.editor.js',
			array( 'wp-editor' ),
		...
		$this->toolset_assets_manager->register_style(
			...
			$this->constants->constant( 'WPV_URL' ) . ViewsEditorBlocks\Blocks::VIEWS_BLOCKS_ASSETS_RELATIVE_PATH . '/css/ct.block.editor.css',
			array(),
			$this->constants->constant( 'WPV_VERSION' )
		);
	}
