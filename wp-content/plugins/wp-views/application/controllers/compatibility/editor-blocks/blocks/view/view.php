...
class Block extends ViewsEditorBlocks\Base {
	...
	public function register_block_editor_assets() {
		$this->toolset_assets_manager->register_script(
			...
			$this->constants->constant( 'WPV_URL' ) . ViewsEditorBlocks\Blocks::VIEWS_BLOCKS_ASSETS_RELATIVE_PATH . '/js/view.block.editor.js',
			array( 'wp-editor' ),
		...
		$this->toolset_assets_manager->register_style(
			...
			$this->constants->constant( 'WPV_URL' ) . ViewsEditorBlocks\Blocks::VIEWS_BLOCKS_ASSETS_RELATIVE_PATH . '/css/view.block.editor.css',
			array(),
			$this->constants->constant( 'WPV_VERSION' )
		);
	}
