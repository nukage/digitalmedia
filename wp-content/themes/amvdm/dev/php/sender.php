...
if(isset($_POST['email'])) {
    ...
    // EDIT THE BELOW TWO LINES AS REQUIRED Please replace email = example@icon.com, for recived contact email
    $email_to = "mleatherman@amvdm.com";
    $email_to2 = "bb@angelfilme.com";
    $email_subject = "Message From AMVDM website form.";
